...
namespace StarTracker::Ephemeris::Coordinates::Transform {
	...
	*
	*/
	[[nodiscard]] Rectangular SphericalToRectangular(const Spherical& coords) noexcept;
	...
	*
	*/
	[[nodiscard]] Spherical RectangularToSpherical(const Rectangular& coords) noexcept;
	...
	*
	*/
	[[nodiscard]] Rectangular RotateRectangular(const Rectangular& rectCoords, double angle) noexcept;
	...
	*
	*/
	[[nodiscard]] Horizontal EquatorialToHorizontal(double declination, double hourAngle, double latitude) noexcept;
	...
	*
	*/
	[[nodiscard]] Horizontal TerrestrialObserverToHorizontal(const Spherical& sphericalCoords, const Terrestrial& observer, const DateTime& date) noexcept;
}
